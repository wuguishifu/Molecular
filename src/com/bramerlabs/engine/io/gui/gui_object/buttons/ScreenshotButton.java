...
public class ScreenshotButton extends Button {
    ...
    public static final int ID = Button.BUTTON_SCREENSHOT;

    // the different textures
    private static final String unpressedTexture = "/textures/buttons/button_screenshot.png";
    private static final String pressedTexture = "/textures/buttons/button_screenshot_pressed.png";
     ...
     */
    public ScreenshotButton(float x, float y, float width, float height, GuiMesh defaultMesh, GuiMesh stateMesh) {
     ...
     */
    public static ScreenshotButton getInstance(Vector2f position, Vector2f size) {
        ...
        return new ScreenshotButton(position.getX(), position.getY(), size.getX(), size.getY(),
     ...
     * @return - the button
     */
    public static ScreenshotButton getInstance(int x1, int y1, int width, int height, Window window) {
        float windowWidth = window.getWidth();
        float windowHeight = window.getHeight();
        return ScreenshotButton.getInstance(new Vector2f(x1 / windowWidth - 1f, y1 / windowHeight - 1f), new Vector2f(width / windowWidth, height / windowHeight));
    }
