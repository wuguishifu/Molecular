...
public class LoadButton extends Button {
    ...
    public static final int ID = Button.BUTTON_LOAD;

    // the different textures
    private static final String unpressedTexture = "/textures/buttons/button_load.png";
    private static final String pressedTexture = "/textures/buttons/button_load_pressed.png";
     ...
     */
    public LoadButton(float x, float y, float width, float height, GuiMesh defaultMesh, GuiMesh stateMesh) {
     ...
     */
    public static LoadButton getInstance(Vector2f position, Vector2f size) {
        ...
        return new LoadButton(position.getX(), position.getY(), size.getX(), size.getY(),
     ...
     * @return - the button
     */
    public static LoadButton getInstance(int x1, int y1, int width, int height, Window window) {
        float windowWidth = window.getWidth();
        float windowHeight = window.getHeight();
        return LoadButton.getInstance(new Vector2f(x1 / windowWidth - 1f, y1 / windowHeight - 1f), new Vector2f(width / windowWidth, height / windowHeight));
    }
